...
These files contain 3,000,000 anonymous ratings as dumped on April 4, 2006.
...
- UserIDs range between 1 and 135,359 (It is likely that not all users rated)
...
User information is in the file "users.Rdata” and is in the following
format:
...
- State, City are the fields the User wrote for the state and city he/she current lives in
- Employer,Occupation are the fields the User wrote for his current employer and occuptation.
- Ratedate is the date the User signed up for LibimSeTi